                ...
                <div className="pricing-table">
                    ...
                    >
                        ...
                        <div className="plan-price">
                            <span className="plan-price-amount" style={{color: 'black'}}>
                                <span className="plan-price-currency">$</span>
                                {(plans.copper.price * (this.coupon === 'prelaunch-coupon' ? 0.7 : 1)).toFixed(1)}
                            </span>
                            /month
                        </div>
                        <div className="plan-items">
                    ...
                    >
                        ...
                        <div className="plan-price">
                            <span className="plan-price-amount" style={{color: 'black'}}>
                                <span className="plan-price-currency">$</span>
                                {(plans.silver.price * (this.coupon === 'prelaunch-coupon' ? 0.7 : 1)).toFixed(1)}
                            </span>
                            /month
                        </div>
                        <div className="plan-items">
                    ...
                    >
                        ...
                        <div className="plan-price">
                            <span className="plan-price-amount" style={{color: 'black'}}>
                                <span className="plan-price-currency">$</span>
                                {(plans.gold.price * (this.coupon === 'prelaunch-coupon' ? 0.7 : 1)).toFixed(1)}
                            </span>
                            /month
                        </div>
                        <div className="plan-items">
