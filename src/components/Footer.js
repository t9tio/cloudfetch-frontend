    ...
    return <footer className="footer">
        <div className="container">
            ...
            <div style={{ float: 'right'}}>
                <a className="button is-white" href="https://join.slack.com/t/cloudfetch/shared_invite/enQtNTA5NzIyNTU2Mzc1LTIwNzZiODZkNzFiODY0NTM4OWViYjgxN2JkNGY0NzJiYWQzNTcwYzM3NjMwMmE2N2RkMzE0ZGRlYWJkYTY3Yzg"><i className="fab fa-slack"></i></a>
